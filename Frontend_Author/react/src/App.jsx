...
function App() {
  ...
  useEffect(() => {
    let allData=async () => {
      ...
      let res=await fetch(`https://blog-api-yk96.onrender.com/AdminArticles`,{
  ...
  async function handleSubmit(e,id){
    ...
    let res=await fetch(`https://blog-api-yk96.onrender.com/delete?id=${id}`,{
      method:"POST",
      ...
      <div>
        ...
        {articles && articles.Articles && articles.Articles.map(article => {
          return <div className={styles.article}>
            ...
            <img className={styles.admin_imgs} src={`https://blog-api-yk96.onrender.com/${article.cover_page}`} alt="" />
            <p>{article.title}</p>
